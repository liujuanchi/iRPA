...
# my_dir = '/Users/maoyuanq/Desktop'
## C:/Users/Administrator/Desktop/
os.chdir('C:/Users/Administrator/Desktop')
if os.path.exists('C:/Users/Administrator/Desktop/wenjian'):
    os.remove('C:/Users/Administrator/Desktop/wenjian')
os.mkdir('wenjian')
...
while iter_flag == False:
    if os.path.exists("complete_log" + str(admin_law.split('/')[-2]) + ".txt"):  # 如果是中途断点
        with open("complete_log" + str(admin_law.split('/')[-2]) + ".txt", 'r') as f:
            params = f.read().split(',')
            start_pag = int(params[0])
            iter_flag = history_data(admin_law, start_pag)
    else:  # 如果是首次运行
        iter_flag = history_data(admin_law, 1)
...
#upload
s3_function.upload_to_aws_s3('admin.zip','storageforccbrpa','admin_history.zip')
...
while iter_flag == False:
    if os.path.exists("complete_log" + str(compliance_url.split('/')[-2]) + ".txt"):  # 如果是中途断点
        with open("complete_log" + str(compliance_url.split('/')[-2]) + ".txt", 'r') as f:
            params = f.read().split(',')
            start_pag = int(params[0])
            iter_flag = history_data(compliance_url, start_pag)
    else:  # 如果是首次运行
        iter_flag = history_data(compliance_url, 1)
...
#upload
s3_function.upload_to_aws_s3('compliance.zip','storageforccbrpa','compliance_history.zip')
...
while iter_flag == False:
    if os.path.exists("complete_log" + str(regulation_url.split('/')[-2]) + ".txt"):  # 如果是中途断点
        with open("complete_log" + str(regulation_url.split('/')[-2]) + ".txt", 'r') as f:
            params = f.read().split(',')
            start_pag = int(params[0])
            iter_flag = history_data(regulation_url, start_pag)
    else:  # 如果是首次运行
        iter_flag = history_data(regulation_url, 1)
...
#upload
s3_function.upload_to_aws_s3('regulation.zip','storageforccbrpa','regulation_history.zip')
...
while iter_flag == False:
    if os.path.exists("complete_log" + str(other_url.split('/')[-2]) + ".txt"):  # 如果是中途断点
        with open("complete_log" + str(other_url.split('/')[-2]) + ".txt", 'r') as f:
            params = f.read().split(',')
            start_pag = int(params[0])
            iter_flag = history_data(other_url, start_pag)
    else:  # 如果是首次运行
        iter_flag = history_data(other_url, 1)
...
#upload
s3_function.upload_to_aws_s3('others.zip','storageforccbrpa','others_history.zip')
