...
while flag == False:
    flag = history_data(law_url)
print('part 1. executes successfully')

flag = False
admin_law = 'http://www.pbc.gov.cn/tiaofasi/144941/144953/21888/index'
while flag == False:
    flag = history_data(admin_law)
print('part 2. executes successfully')

flag = False
compliance_url = 'http://www.pbc.gov.cn/tiaofasi/144941/3581332/3b3662a6/index'
while flag == False:
    flag = history_data(compliance_url)
print('part 3. executes successfully')

flag = False
regulation_url = 'http://www.pbc.gov.cn/tiaofasi/144941/144957/21892/index'
while flag == False:
    flag = history_data(regulation_url)
print('part 4. executes successfully')

flag = False
other_url = 'http://www.pbc.gov.cn/tiaofasi/144941/144959/21895/index'
while flag == False:
    flag = history_data(other_url)
print('part 5. executes successfully')
